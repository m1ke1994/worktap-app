  ...
  <footer class="bg-[#F7F6FF] py-12">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h3 class="text-lg font-bold mb-4 text-gray-800">Контакты</h3>
          <div class="space-y-4">
            <div>
              <p class="text-gray-600">Email: info@example.com</p>
              <p class="text-gray-600">Телефон: +7 (123) 456-78-90</p>
            </div>
            
            <div class="flex space-x-4">
              <a href="#" class="text-gray-600 hover:text-[#1DBF73] transition">
      ...
      <div class="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-500 text-sm mb-4 md:mb-0">© 2023 Ваша компания. Все права защищены.</p>
        <div class="flex space-x-6">
          <a href="#" class="text-gray-500 hover:text-[#1DBF73] text-sm transition">Политика конфиденциальности</a>
          <a href="#" class="text-gray-500 hover:text-[#1DBF73] text-sm transition">Условия использования</a>
          <a href="#" class="text-gray-500 hover:text-[#1DBF73] text-sm transition">Cookie</a>
        </div>
      </div>
    </div>
  </footer>
